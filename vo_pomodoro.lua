...
-- @version 1.0
-- @author Evgeniy Metelev
-- @about
--   #Pomodoro Timer  
--   Timer for Pomodoro Technique  
--   [Read about pomodoro](https://en.wikipedia.org/wiki/Pomodoro_Technique)
-- @link https://github.com/evgazloy/reaper-pomodoro
-- @donate https://paypal.me/evgazloy

-- vo_pomodoro.lua
-- Copyright (C) 2021 Evgeniy Metelev
